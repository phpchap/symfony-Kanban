 ...
 * @method Task                setDepartments()                Sets the current record's "Departments" collection
 * @method Task                setTaskDepartments()            Sets the current record's "TaskDepartments" collection
 * 
 * @package    sf_sandbox
 * @subpackage model
...
abstract class BaseTask extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('phase_id', 'integer', 4, array(
             'type' => 'integer',
             'length' => 4,
             ));
